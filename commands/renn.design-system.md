...
RENN > PROJECT DESIGN SYSTEM COMPLETE
...
- UX Brief: .renn/design/ux-brief.md

## Next Up

**Design Screens** -- create screen prototypes for each UI stage

/renn.design-screens {N}  (where N is the first UI stage)
...
- /renn.design-system -- re-run design system creation
...
- [ ] User directed to /renn.design-screens as next step
</success_criteria>
</output>
